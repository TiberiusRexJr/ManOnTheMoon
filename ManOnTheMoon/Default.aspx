...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid mx-auto " style="width:100%; z-index:0">
...
<!-- Carousel wrapper -->
    ...
    <!--DivCardHolder_START-->
    <div class="container-fluid mx-auto" style="z-index:1; width:92%; margin-top:-30%; background-color: rgb(97, 63, 18);">
  <div class="container float-left px-3 py-3" style="width: 25%; z-index:1; margin-top:0%; background-color: rgb(247, 216, 176);">
<div class="row">
<div class="col-5">
     <!-- Card Dark -->
     <div class="card">
      ...
      <div class="card-body elegant-color white-text rounded-bottom">
        ...
        <!-- Title -->
        <h6 class="card-title text-left">Card title</h6>
...
<!-- Card Dark -->
      ...
      <p class="card text-center" style="width:82%;"><strong>Customers' most-loved</strong></p>
</div>
        <!--DivCardContent2-->
          <div class="container float-left px-3 py-3" style="width: 25%; z-index:1; margin-top:0%; background-color: rgb(247, 216, 176);">
            <div class="row">
        ...
        <!--DivCardContent2-->
        <!--SubCArdHolderRight_start-->
        <div class="container-flex float-right px-3 py-3" style="width: 50%; z-index:1; margin-top:0%; background-color: rgb(247, 216, 176);">
            <div class="row">
                <div class="col-6">
                <!-- Card Regular -->
